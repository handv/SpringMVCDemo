...
<div class="body">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <a class="navbar-brand pull-right" href="mailto:123@qq.com?subject=设备登记系统意见反馈"><span
                class="glyphicon glyphicon-envelope" title="意见反馈"></span></a>
    </nav>
    <!-- 主页面  -->
    <div class="main">
        <!-- ##翻译质量数据列表 -->
                        ...
                        <div class="tab-pane fade in active" id="android-list">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>占有率</td>
                                    <td>持有者</td>
                                    <td>借用者： <input type="text" class="borrower_${product_current.id}"
                                                    placeholder="请向持有者借用后再修改"></td>
                                    <td>时间</td>
                                    <td>备注</td>
                                </tr>
                                </thead>
